...
<section class="main-blog">
    <div class="blog-berita">
      <img src="{{ Storage::url($blog_main->thumbnail) }}" alt="" class="img-berita" />
      <div class="blog-paragraf">
        <h2>{{ $blog_main->title }}</h2>
        <p>
          {!! strip_tags($blog_main->content) !!}
        </p>
        <a href="{{ $blog_main->link }}"><button class="btn-dark-custom mt-3">BACA SELENGKAPNYA</button></a>
      </div>
    </div>
  </section>
  <!-- Main Blog End -->
